...
class MAX30105 {
 public: 
  ...
  uint8_t setup(byte powerLevel = 0x1F, byte sampleAverage = 4, byte ledMode = 3, int sampleRate = 400, int pulseWidth = 411, int adcRange = 4096);

  // Low-level I2C communication
  char readRegister8(uint8_t address, uint8_t reg);
